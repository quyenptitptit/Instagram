...
export default function User({ params }: { params: { username: string } }) {
  return (
    <div>
      ...
      <div className="flex-col items-center p-8 max-[736px]:px-0 max-[736px]:items-start">
          ...
          <div className="flex-col max-w-[600px]">
            ...
            <div className="flex mb-5 max-[736px]:hidden">
              ...
              <button className="mx-1 px-4 py-[2px] text-sm">
                <span className="font-semibold uppercase">76.7K</span> followers
              </button>
              <button className="mx-1 px-4 py-[2px] text-sm">
        ...
        <div className="flex-col hidden mb-2 text-sm max-[736px]:flex max-[736px]:px-4">
          ...
          <p className="">
            Cuộc đời ta thay đổi theo 2 cách: Qua những cuốn sách ta đọc và qua
            những người ta gặp
          </p>
          <p className="">
            Cuộc đời ta thay đổi theo 2 cách: Qua những cuốn sách ta đọc và qua
        ...
        <div className="grid grid-cols-3 grid-flow-row">
          <div className="relative ">
            <Image
              src="https://i.pinimg.com/564x/f7/37/0f/f7370fb06b911cf3817da25819d5ecd0.jpg"
              alt=""
              fill
              objectFit="cover"
            />
